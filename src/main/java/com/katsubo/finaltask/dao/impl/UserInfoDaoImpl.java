...
public class UserInfoDaoImpl extends BaseDaoImpl implements UserInfoDao {
    ...
    public static final String READ_BY_USER = "SELECT `id`, `name`, `surname`, `about`, `picture_link`, `email`, `date_of_birth`, " +
            "`date_of_registration` FROM `users` WHERE `user_id` = ?";
    public static final String CREATE = "INSERT INTO `user_info` (`user_id`, `name`, `surname`, `about`, `picture_link`, `date_of_birth`, \" +\n" +
            "                \"`date_of_registration`) VALUE (?, ?, ?, ?, ?, ?, ?)";
    public static final String READ = "SELECT `user_id`, `name`, `surname`, `about`, `picture_link`, `email`, `date_of_birth`, " +
            "`date_of_registration` FROM `users` WHERE `id` = ?";
    public static final String UPDATE = "UPDATE `user_info` SET `user_id` = ?, `name` = ?, `surname` = ?, `about` = ?, `picture_link` = ?, " +
            "`email` = ?, `date_of_birth` = ?, `date_of_registration` = ? WHERE `id` = ?";
