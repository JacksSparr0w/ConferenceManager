...
<div class="container-fluid pb-5 pl-5 pr-5">
    <div class="row">
        <div class="col-8 m-2">
            ...
            <strong class="d-inline-block mb-2 text-black">Add new theme</strong>
            <form action="add_theme" method="post">
                <div class="row pt-3 pl-3 pr-3">
                    <div class="col-md-6">
                        <label for="theme">Name of new theme</label>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="m-2">
            <strong class="d-inline-block mb-2 text-black">Existing themes</strong>
